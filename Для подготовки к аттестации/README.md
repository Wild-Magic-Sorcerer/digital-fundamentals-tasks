...
| ip addr | Как выглядят корректные IP адреса. |
...
| git | clone, repo, init, pull, push, commit, status. Правильный порядок команд при загрузке/выгрузки информации. |
| pip | `pip install <название>[/]`. Помнить при каких условиях можно устанавливать. |
| cmake/make | Помнить порядок установки пакета. |
...
| git | Что это такое, для чего нужно. Что такое ветки, как их можно сливать воедино (3 варианта). |
| Установка пакетов | Помнить про менеджеры пакетов, их разницу. Знать как устанавливать самые простые пакеты при помощи pip и cmake. |